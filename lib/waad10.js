...
Waad10.prototype.getSingleUserByUpn = function (upn, callback) {
  return this.getUser(upn, function (err, users) {
    if (err) return callback(err);
    return callback(null, users[0]);
  });
};
...
Waad10.prototype.getUsers = function (id, options, callback) {
  var qs = {};
  ...
  return this.__queryUser(id, qs, callback);
};
